...
from apps.quizzes.models import Chapter, Question, QuizAttempt, AttemptAnswer
...
class ChapterTests(TestCase):
    ...
    def test_chapter_multiple_same_course(self):
        ...
        ch1 = Chapter.objects.create(course=self.course, title="Ch1")
        ch2 = Chapter.objects.create(course=self.course, title="Ch2")
