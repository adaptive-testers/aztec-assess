...
export default function SignUpContainer() {
    ...
    try {
      ...
      if (axios.isAxiosError(error)) {
        ...
        if (errorData?.first_name) {
          setError("firstName", {
            message: Array.isArray(errorData.first_name)
        ...
        if (errorData?.last_name) {
          setError("lastName", {
            message: Array.isArray(errorData.last_name)
        ...
        if (!fieldErrorSet) {
          ...
          setError("root", {
            message:
              backendMessage || "An error occurred while creating your account",
          });
        }
      } else {
        setError("root", {
  ...
  return (
    <>
      ...
      >
        <div>
          <p className="text-primary-text geist-font text-[27px] font-[415] mt-3">
            Sign Up
          </p>
        </div>
        ...
        <div className="w-full pl-4 pr-4">
          ...
          >
            <div className="flex gap-3">
              <div className="relative flex-1">
                <label
                  ...
                  className="text-secondary-text geist-font text-sm font-[475]"
                >
                  First Name
                </label>
                <input
                  ...
                  id="firstName-input"
                  type="text"
                  className="peer text-primary-text text-sm pl-10 pr-2 h-9 w-full border-primary-border border-[2px] rounded-lg focus:border-primary-accent focus:outline-none"
                />
              ...
              <div className="relative flex-1">
                ...
                <input
                  ...
                  id="lastName-input"
                  type="text"
                  className="peer text-primary-text text-sm pl-3 pr-2 h-9 w-full border-primary-border border-[2px] rounded-lg focus:border-primary-accent focus:outline-none geist-font"
                />
                {errors.lastName && (
                  <p className="absolute left-0 bottom-[-18px] tracking-wider geist-font text-error-text text-[10px]">
            ...
            <button
              ...
              className="text-primary-text bg-primary-accent w-full h-[35px] rounded-[6px] tracking-wider geist-font font-[250] text-[13px] mt-4 cursor-pointer transition-all duration-200 origin-center will-change-transform hover:bg-primary-accent-hover hover:shadow-[0_2px_12px_0_rgba(192,74,74,0.25)]"
            >
          ...
          <div className="mt-10">
            <div className="flex items-center w-full gap-1">
              ...
              <span className="text-secondary-text geist-font font-[550] text-[11px] px-2">
                OR
              </span>
              <div className="flex-1 h-[1px] bg-primary-border" />
            </div>
          ...
          <div className="geist-font text-[12px] font-[150] tracking-wider mt-10 flex justify-center">
            <p className="text-primary-text">
              ...
              <a
                href="/login"
                className="text-primary-accent transition-all duration-500 hover:underline"
              >
                Log in
              </a>
            </p>
